...
{
    /// <summary>
    /// Credit goes to: https://github.com/robvolk/Helpers.Net/blob/master/Src/Helpers.Net/StringHtmlExtensions.cs
    /// </summary>
    public static class StringHtmlExtensions
    {
        ...
        public static string TruncateHtml(this string html, int maxCharacters, string trailingText = "...")
        {
            ...
            var trunc = new StringBuilder(html.TruncateWords(charCount, null));
        ...
        public static string TruncateWords(this string text, int maxCharacters, string trailingText = "...")
        {
            ...
            return Regex.Replace(text.Truncate(maxCharacters, null),
